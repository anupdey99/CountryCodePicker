package com.github.anupdey99.ccplib;
...
import com.github.anupdey99.ccplib.fastscroll.FastScroller;
...
class CountryCodeDialog {
    ...
    openCountryCodeDialog(final CountryCodePicker codePicker, final String countryNameCode) {
        ...
        attributes.height = (int) (context.getResources().getDisplayMetrics().heightPixels * 0.8);
